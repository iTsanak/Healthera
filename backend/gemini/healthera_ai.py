    ...
    def __init__(self):
        ...
        self.model = genai.GenerativeModel(
            ...
            system_instruction=(
                ...
                "Bias Against Unhealthy Ingredients: Ingredients like canola oil, palm oil, vegetable oil, and high-fructose corn syrup and anything unhealthy or of similar type should always have lower scores due to their associations with processed or unhealthy products, regardless of other ingredients and should drop the overall score, for example if you have potatoes and vegetable oil it would probably mean it's chips which is very unhealthy."
                ...
                "The range of categories: For example fried, higly processed, soft drinks like soda, chips etc should be between no more than 30 level, you are ranking everything higher, don't do that just drop the score for the obvious unhealthy products."
                "Invalid Images: If the image is not a product's ingredients label or an ingredient list, prompt the user to upload a picture of a product's ingredients."
